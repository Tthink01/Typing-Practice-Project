...
export const EXERCISES_DATA = {
  basic: {
    TH: [
      ...
      {
        id: 4, title: "ด่านที่ 4", sub: "แถวตัวเลข",
        content: "จุ คุ ตุ ถุ ภุ ขุ ชุ จึ คึ ตึ ถึ ภึ ขึ ชึ จุใจ คึกคัก คาดคิด ติดขัด รู้สึก นึกถึง ภาระ ภูเขา รถ ถนน ถุงมือ คน คิด คอ ตา ตก โต จะ จริง ใจ เขา ขา แขน ชาย ชา ช้าง ชูมือ ไข่ไก่ ถือของ"
      },
      {
