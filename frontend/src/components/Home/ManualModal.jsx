...
const ManualModal = ({ isOpen, onClose, images = [] }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/90 backdrop-blur-sm p-4 animate-fade-in">
      ...
      {/* Container หลัก */}
      <div className="relative w-full max-w-5xl h-[90vh] bg-white dark:bg-stone-900 rounded-xl shadow-2xl overflow-hidden flex flex-col transition-colors duration-300">
        ...
        {/* พื้นที่แสดงรูปภาพ */}
        <div className="flex-1 flex items-center justify-center bg-gray-200 dark:bg-stone-800 relative overflow-hidden transition-colors duration-300">
        ...
        <div className="h-16 bg-gray-100 dark:bg-stone-950 border-t border-gray-200 dark:border-stone-800 flex items-center justify-center gap-4 text-gray-900 dark:text-white transition-colors duration-300">
            <span className="text-gray-500 dark:text-stone-400 text-sm">
                ...
                {images.map((_, idx) => (
                    <div 
                        ...
                        className={`w-2 h-2 rounded-full transition-colors ${
                            idx === currentIndex ? "bg-orange-500" : "bg-gray-300 dark:bg-stone-600"
                        }`}
                    />
                ))}
            </div>
