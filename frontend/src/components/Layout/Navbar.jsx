...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full flex justify-between items-center px-6 py-4 z-50 bg-white/95 dark:bg-[#1c1917]/95 backdrop-blur-md border-b border-gray-200 dark:border-[#f97316]/20 shadow-lg transition-colors duration-300">
      {/* 1. Logo */}
      <Link
        to="/"
      ...
      >
        ...
        <span className="text-gray-800 dark:text-gray-100 font-bold text-lg tracking-wide hidden md:block">
          E & T Typing
        </span>
      </Link>
      ...
      <div className="absolute left-1/2 transform -translate-x-1/2">
        <div className="bg-gray-100 dark:bg-[#27272a] border border-gray-200 dark:border-[#3f3f46] rounded-full px-8 md:px-12 py-3 md:py-4 flex items-center gap-8 md:gap-10 shadow-inner transition-colors duration-300">
          <Link
            to="/"
            state={{ forceShowWelcome: true }}
            title="หน้าต้อนรับ"
      ...
      {/* 3. ส่วน User & Theme Toggle */}
      <div className="flex items-center gap-4">
        <ThemeToggle />
        {user ? (
          <div className="flex items-center font-itim gap-3 bg-gray-100 dark:bg-[#27272a] pl-4 pr-1 py-1 rounded-full border border-gray-200 dark:border-[#3f3f46] hover:border-orange-500/30 transition-colors duration-300">
          ...
          <Link to="/login">
            <button className="flex items-center gap-2 bg-gray-100 dark:bg-[#27272a] hover:bg-gray-200 dark:hover:bg-[#3f3f46] text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white px-5 py-2.5 rounded-full border border-gray-200 dark:border-[#3f3f46] text-sm font-itim transition-all duration-200 hover:border-gray-400 dark:hover:border-gray-500 hover:shadow-md">
              <User size={16} />
