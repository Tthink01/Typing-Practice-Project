  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 animate-fade-in font-sans">
      ...
      <div
        ...
        } rounded-3xl p-6 sm:p-8 max-w-md w-full shadow-2xl flex flex-col h-[80vh] sm:h-auto sm:max-h-[85vh] animate-scale-up`}
      >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-6 relative z-10">
          <div
            className={`${
              isBasic
                ? "bg-lime-500/20 text-lime-100 border-lime-500/40"
          ...
          <div className="flex items-center gap-2 bg-stone-800 rounded-full p-1 border border-stone-700">
            <button
              ...
              className={`px-3 py-1 rounded-full text-sm font-medium transition-all ${
                language === "TH" ? "bg-stone-600 text-white" : "text-stone-400"
              }`}
            >
              TH
            </button>
            <button
              ...
              className={`px-3 py-1 rounded-full text-sm font-medium transition-all ${
                language === "EN" ? "bg-stone-600 text-white" : "text-stone-400"
              }`}
            >
              EN
            </button>
          ...
          <button
            onClick={onClose}
            className="absolute -top-4 -right-4 sm:static sm:top-auto sm:right-auto p-2 text-stone-500 hover:text-white transition-colors"
          >
            <X size={24} />
          </button>
        </div>
